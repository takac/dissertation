...
determines the likelihood of a mutation on a gene within an individual.
...
a program for evaluation ~cite{gpintro98}. Each individual in the population represents an entire program, rather than a set of values which can be
